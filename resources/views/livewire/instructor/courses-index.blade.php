    ...
    @if($courses->count())
        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            @foreach ($courses as $course)
                ...
                @else
                    <img id="picture" class="h-10 w-10 rounded-full object-cover object-center" src="https://images.pexels.com/photos/572056/pexels-photo-572056.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" alt="">
                @endisset
