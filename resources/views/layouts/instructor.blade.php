            ...
            <div class="container py-8 grid grid-cols-5 gap-6">
                <aside>
                    ...
                    <ul class="text-sm text-gray-600 mb-4">
                        ...
                        <li class="leading-7 mb-1 border-l-4 @routeIs('instructor.courses.curriculum', $course) border-indigo-400 @else border-transparent @endif pl-2"><a href="{{route('instructor.courses.curriculum', $course)}}">Lecciones del curso</a> </li clas="leading-7 mb1 border-l-4">
