<x-app-layout>
    ...
    <div class="card text-gray-600">
        <div class="card-body">
            ...
            <hr>
            <p class="text-sm mt-4">Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae ducimus esse, cum repudiandae accusamus animi iure aperiam id tenetur totam. Facere dolorum sunt amet temporibus autem deserunt dolor, nam sint. <a class="text-red-500 font-bold" href="">Términos y condiciones</a></p>
        </div>
    </div>
</div> 
</x-app-layout>